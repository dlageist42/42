...
/**
 * @file
 * FormBit file for adimeo_development feature mdoule.
 */
 ...
 */
function adimeo_development_get_editable_config_names() {
  $editable_cofnigs = [
    'system.logging' => [
 ...
 *   Install state.
 */
function adimeo_development_build_formbit(array &$formbit, FormStateInterface &$form_state, array &$install_state = NULL) {
  $formbit['error_level'] = [
    '#type' => 'radios',
 ...
 */
function adimeo_development_submit_formbit(array $editable_config_values) {
