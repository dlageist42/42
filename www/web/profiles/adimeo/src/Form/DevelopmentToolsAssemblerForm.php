...
class DevelopmentToolsAssemblerForm extends FormBase {
   ...
   * The form helper.
   *
   * @var \Drupal\adimeo\AssemblerFormHelper
   */
   ...
   * @param \Drupal\adimeo\Form\FormHelper $form_helper
   *   The form helper.
   */
  ...
  public static function create(ContainerInterface $container) {
    ...
    $container->get('adimeo.form_helper')
    );
  }
  ...
  public function getFormId() {
    return 'adimeo_development_tool';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, array &$install_state = NULL) {
    ...
    $form['development_tools_introduction'] = [
      '#weight' => -1,
      '#prefix' => '<p>',
      '#markup' => $this->t("If you're only evaluating Adimeo, you don't need to install these tools. These tools are needed if you're a developer and you're installing Adimeo to build a new site."),
      '#suffix' => '</p>',
    ];
      ...
      foreach ($developmentTools as $development_tool_key => $development_tool_info) {
        ...
        if (isset($development_tool_info['config_form']) &&
          ...
          if (isset($development_tool_info['formbit'])) {
            $formbit_file_name = drupal_get_path('profile', 'adimeo') . '/' . $development_tool_info['formbit'];
      ...
      foreach ($developmentTools as $development_tool_key => $development_tool_info) {
        ...
        if (isset($development_tool_info['config_form']) &&
          ...
          if (file_exists($formbit_file_name)) {
            ...
            $GLOBALS['install_state']['adimeo']['development_tools_configs'] = $development_tools_editable_configs;
          }
        }
      }

      $GLOBALS['install_state']['adimeo']['development_tools_values'] = $development_tools_values;
    }
  }
