...
class AssemblerForm extends FormBase {
  ...
  public function getFormId() {
    return 'adimeo_extra_components';
  }
      ...
      foreach ($extraFeatures as $extra_feature_key => $extra_feature_info) {
        ...
        if (isset($extra_feature_info['config_form']) &&
          ...
          if (isset($extra_feature_info['formbit'])) {
            $formbit_file_name = drupal_get_path('profile', 'adimeo') . '/' . $extra_feature_info['formbit'];
      ...
      foreach ($extraFeatures as $extra_feature_key => $extra_feature_info) {
        ...
        if (isset($extra_feature_info['config_form']) &&
          ...
          if (file_exists($formbit_file_name)) {
            ...
            $GLOBALS['install_state']['adimeo']['extra_features_configs'] = $extra_features_editable_configs;
          }
        }
      }

      $GLOBALS['install_state']['adimeo']['extra_features_values'] = $extra_features_values;
    }
