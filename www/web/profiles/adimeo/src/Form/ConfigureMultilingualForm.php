...
/**
 * Defines form for selecting Adimeo's Multiligual configuration options form.
 */
class ConfigureMultilingualForm extends FormBase {
  ...
  public function getFormId() {
    return 'adimeo_multilingual_configuration';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $GLOBALS['install_state']['adimeo']['enable_multilingual'] = $enable_multilingual;
    ...
    $GLOBALS['install_state']['adimeo']['multilingual_languages'] = $multilingual_languages;
  }
